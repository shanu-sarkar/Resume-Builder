...
//mapStateToProps assigns the experiences arr from the workExperienceReducer in the Redux state to the component's props. This enables the component to access the experiences arr.
const mapStateToProps = (state) => ({
  experiences: state.workExperienceReducer.experiences,
});

//mapDispatchToProps is an empty obj. It usually connects action creators to props.
